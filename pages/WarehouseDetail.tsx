...
function getWarehouseInventoryUom(inventoryId: { unitOfMeasure?: string; uomConversions?: import("../types/uom").UomConversion[] }) {
  return {
    baseUnit: inventoryId.unitOfMeasure?.trim() || "piece",
    conversions: inventoryId.uomConversions,
  };
}
...
export const WarehouseDetail: React.FC = () => {
  ...
  const openAdjustmentModal = (
    ...
    setAdjustmentReason("");
    const { baseUnit } = getWarehouseInventoryUom(item.inventoryId);
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-md">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                {(() => {
                  const { baseUnit, conversions } = getWarehouseInventoryUom(selectedStockItem.inventoryId);
