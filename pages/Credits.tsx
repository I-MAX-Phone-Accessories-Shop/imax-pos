    ...
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          ...
          className="bg-btn-primary text-dark px-4 py-2 rounded flex items-center gap-2 hover:bg-btn-primary-hover"
        >
              ...
              <tr key={c.id} className="hover:bg-slate-50">
                ...
                <td
                  className={`px-4 py-3 text-right font-bold ${
                    c.outstandingBalance > 0 ? "text-red-500" : "text-green-500"
                  }`}
                >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg w-80">
            ...
            <button
              ...
              className="w-full bg-btn-primary text-dark py-2 rounded"
            >
              Save
            </button>
            <button
              onClick={() => setIsAddOpen(false)}
              className="w-full mt-2 text-slate-500 text-sm"
            >
              Cancel
            </button>
          </div>
