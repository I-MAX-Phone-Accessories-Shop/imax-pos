...
import { LayoutDashboard, ShoppingCart, Package, Truck, CreditCard, PieChart, Settings, ShoppingBag } from 'lucide-react';
  ...
  return (
    <div className="w-64 bg-slate-900 text-white flex flex-col h-screen fixed left-0 top-0 pt-8 shadow-xl print:hidden">
      <div className="px-6 mb-8">
        <h1 className="text-2xl font-bold text-blue-400 tracking-tight">MobileAx</h1>
      ...
      <nav className="flex-1 px-2 space-y-1">
        {menuItems.map((item) => {
          ...
          if (item.id === 'purchasing' && currentUser.role !== 'ADMIN') return null;
