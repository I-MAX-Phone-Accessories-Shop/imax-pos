export const en = {
  ...
  ecommerceOrders: {
    ...
    subtitle: "Manage online shop orders from one place",
    ...
    actions: "Actions",
    view: "View / Status",
    totalItemsLabel: "Total {count} orders",
    ...
    failedToLoad: "Failed to load ecommerce orders",
  },
  customers: {
    title: "Customers",
    ...
    registerFailed: "Failed to register customer",
  ...
  quotation: {
    ...
    paymentMethod: "Payment Method",
    paidAmount: "Paid Amount",
    creditPerson: "Credit Person",
    selectCreditPerson: "Select credit person",
    empty: "No quotations found",
    emptyHint: "Create a quotation to share pricing with a customer before checkout.",
    ...
    convert: {
      ...
      creditPersonRequired: "Please select a credit person",
    },
    form: {
