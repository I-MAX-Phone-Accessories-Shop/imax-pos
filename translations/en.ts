export const en = {
  ...
  inventory: {
    ...
    requiredFieldsError: "Product Name, Product Code, SKU, Buying Price, and Selling Price are required",
    sellingPriceError: "Selling Price must be greater than or equal to Buying Price",
  ...
  accountManagement: {
    ...
    confirmDelete: "Are you sure you want to permanently delete this account? This action cannot be undone.",
    deleting: "Deleting...",
  ...
  warehouse: {
    ...
    description: "Description",
    notes: "Notes",
    noWarehouses: "No warehouse profiles found. Click \"Add Warehouse\" to create one.",
  ...
  storefront: {
    ...
    description: "Description",
    notes: "Notes",
    noStorefronts: "No storefront profiles found. Click \"Add Storefront\" to create one.",
    loading: "Loading profiles...",
    viewStockItems: "View Stock Items",
    fillRequiredFields: "Please fill in all required fields",
  ...
  suppliers: {
    ...
    addFirstSupplier: "Add your first supplier using the \"Add Supplier\" button.",
