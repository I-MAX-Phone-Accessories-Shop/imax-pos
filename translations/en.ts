export const en = {
  ...
  onlineOrders: {
    ...
    subtitle: "View and manage orders from the online storefront",
    ...
    actions: "Actions",
    view: "View Details",
    loading: "Loading online orders...",
    noOrders: "No online orders found",
    ...
    delivered: "Delivered",
    cancelled: "Cancelled",
    orderDetails: "Online Order Details",
  },
  creditOrders: {
    title: "Credit Orders",
