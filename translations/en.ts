export const en = {
  ...
  sidebar: {
    checkout: "Sales & Quotations",
    inventory: "Stock Control",
    warehouse: "Yard / Warehouse",
    storefront: "Showroom",
    suppliers: "Suppliers List",
    purchasing: "Purchasing & GRN",
    orders: "All Orders",
    creditOrder: "Credit History",
    creditSales: "Customer Balances",
    expenses: "Expense Tracker",
    reports: "Business Dashboard",
    accountManagement: "Staff & Permissions",
    settings: "Settings",
    logout: "Logout",
  ...
  expenses: {
    ...
    other: "Other",
    fuelCost: "Driver Fuel Cost",
    loadingExpense: "Loading/Labor Expense",
    vehicleMaintenance: "Vehicle Maintenance",
    officeExpense: "Office Expense",
    yardExpense: "Yard Expense",
  ...
  warehouse: {
    title: "Yard / Warehouse Management",
  ...
  suppliers: {
    title: "Suppliers List Management",
